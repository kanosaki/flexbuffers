...
func (b *Builder) PushBlob(blb []byte) error {
	_ = b.Blob(blb)
	return nil
}

func (b *Builder) PushInt(i int64) error {
	b.Int(i)
	return nil
}

func (b *Builder) PushUint(u uint64) error {
	b.UInt(u)
	return nil
}

func (b *Builder) PushFloat(f float64) error {
	b.Float64(f)
	return nil
}

func (b *Builder) PushBool(tf bool) error {
	b.Bool(tf)
	return nil
}

func (b *Builder) PushNull() error {
	b.Null()
	return nil
}

func (b *Builder) BeginArray() (int, error) {
	return b.StartVector(), nil
}

func (b *Builder) EndArray(ptr int) error {
	// TODO: make typed or fixed automatically
	_, err := b.EndVector(ptr, false, false)
	return err
}

func (b *Builder) BeginObject() (int, error) {
	return b.StartMap(), nil
}

func (b *Builder) EndObject(ptr int) error {
	_, err := b.EndMap(ptr)
	return err
}

func (b *Builder) PushObjectKey(k string) error {
	b.Key(s2b(k))
	return nil
}
